    ...
    <div class="wrapper">
        ...
        $(document).ready(function() {
            ...
            function loadData() {
                ...
                $.ajax({
                    url: 'auto_month.php', // Path to your PHP script
                    type: 'GET',
            ...
            $('#monthPicker').on('change', loadData);
        });
    </script>
        ...
        <div class="container-fluid">
            <form>
                <div class="form-group">
                    <label for="monthPicker" class="text-white">Select Date:</label>
                    <input type="month" id="monthPicker" name="date" class="form-control">
                </div>
            </form>
