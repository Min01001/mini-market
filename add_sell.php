...
<div class="col-md-4" style="padding-top: 10px;">
    <div class="vouchers">
        ...
        <form id="voucher-form" method="POST" action="/save_voucher.php">
        ...
        <form id="voucher-form-print" method="POST" action="/box_voucher.php" style="padding-top: 10px;">
            <input type="hidden" name="voucher_data" id="voucher-data-print">
