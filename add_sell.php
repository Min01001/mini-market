        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="title">
                        <h2 class="text-white">Sell Order</h2>
...
<script>
    ...
    function printVoucher() {
        const voucherItems = document.querySelectorAll('.voucher-item');
        let printContent = '<h2>Voucher</h2><table border="1"><tr><th>Product</th><th>Quantity</th><th>Price</th></tr>';

        voucherItems.forEach(item => {
            const product = item.querySelector('.product-name').innerText;
            const quantity = item.querySelector('.quantity').innerText;
            const price = item.querySelector('.product-price').innerText;
            printContent += `<tr><td>${product}</td><td>${quantity}</td><td>${price}</td></tr>`;
        });
