                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo '<div class="card" style="width: 100%; max-width: 300px; height: auto; margin-bottom: 15px;">';
                                echo '<div class="row card-body align-items-center">';
                                echo '  <div class="col-4">';
                                echo '    <img src="' . htmlspecialchars($row['image']) . '" class="img-fluid" alt="' . htmlspecialchars($row['name']) . '" style="width: 100%; height: auto; max-height: 100px; object-fit: cover;">';
                                echo '  </div>';
